...
/*
 *Version SC9850K_Xunrui_L503_V1.0.0
 */
...
{REG_PIN_SD2_D2,                   BIT_PIN_SLP_AP|BITS_PIN_AF(3)|BIT_PIN_SLP_IE},
{REG_MISC_PIN_SD2_D2,              BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NFC_WKUP
