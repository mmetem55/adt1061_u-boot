...
{REG_PIN_CTRL_REG3,0x400},        // IIS1-->AP IIS1 controller
...
{REG_GROUP_PIN_SIM_MS,0x2},      //0000 0000 0000 0000 0000 0000 0000 0010
{REG_GROUP_PIN_SD_MS,0x0},     //0000 0000 0000 0000 0000 0000 0000 0000/  SD2 1.8V IO
...
{REG_GROUP_PIN_EXTINT5,           	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_POC|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//TF_DET
...
{REG_GROUP_PIN_EXTINT10,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//PROX_INT
{REG_PIN_EXTINT9,                 	BITS_AF(0)},
{REG_GROUP_PIN_EXTINT9,           	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//HALL_INT

//G5
{REG_PIN_EXTINT11,                	BITS_AF(3)},
{REG_GROUP_PIN_EXTINT11,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_POC|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},// WB_INT
{REG_PIN_EXTINT7,                 	BITS_AF(3)},
{REG_GROUP_PIN_EXTINT7,           	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_IE},//SIM0_DET / Three in one, TF pullup
{REG_PIN_EXTINT8,                 	BITS_AF(3)},
{REG_GROUP_PIN_EXTINT8,           	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_IE},//SIM1_DET / Three in one, TF pullup
...
{REG_GROUP_PIN_U0CTS,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//BOARD_ID0
{REG_PIN_U0RTS,                		BITS_AF(3)},
{REG_GROUP_PIN_U0RTS,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//BOARD_ID1
...
{REG_GROUP_PIN_WIFI_COEXIST,        BITS_DEF(0x75)|BIT_SLP_NONE|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//FINGER_3V3_EN /IF USE,NEED SLEEP_NONE
{REG_PIN_BEIDOU_COEXIST,            BITS_AF(3)},
{REG_GROUP_PIN_BEIDOU_COEXIST,      BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//FINGER_ID/ VENDOR_ID ???
{REG_PIN_MTCK_ARM,                	BITS_AF(0)},
{REG_GROUP_PIN_MTCK_ARM,          	BITS_DEF(0x75)|BIT_SLP_NONE|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_Z},//MTCK
...
{REG_GROUP_PIN_U3TXD,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_PIN_ISO_VALUE|BIT_SLP_NUL|BIT_SLP_OE},//GPS_U0RXD
...
{REG_GROUP_PIN_RF_LVDS0_DAC_ON,     BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//LCM_SOURCE_AVEEEN
{REG_PIN_RF_LVDS0_ADC_ON,           BITS_AF(3)},
{REG_GROUP_PIN_RF_LVDS0_ADC_ON,     BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//LCM_SOURCE_AVDDEN
...
{REG_GROUP_PIN_RFCTL3,          	BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL3
{REG_PIN_RFCTL4,                	BITS_AF(0)},
{REG_GROUP_PIN_RFCTL4,          	BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL4
{REG_PIN_RFCTL5,                	BITS_AF(0)},
{REG_GROUP_PIN_RFCTL5,          	BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL5
...
{REG_GROUP_PIN_RFCTL9,          	BITS_DEF(0x75)|BIT_SLP_ALL_CP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//RFCTL9
...
{REG_GROUP_PIN_RFCTL13,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//VDDCAMA_EN
{REG_PIN_RFCTL14,                	BITS_AF(3)},
{REG_GROUP_PIN_RFCTL14,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//AG_INT0 / Default active low
{REG_PIN_RFCTL15,                	BITS_AF(3)},
{REG_GROUP_PIN_RFCTL15,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//AG_INT1 / Default active low
...
{REG_GROUP_PIN_U4TXD,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_POC|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//BB_U4TXD
{REG_PIN_U4RXD,                		BITS_AF(3)},
{REG_GROUP_PIN_U4RXD,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPU|BIT_SLP_IE},//ACOK_N
{REG_PIN_U2TXD,                		BITS_AF(0)},
{REG_GROUP_PIN_U2TXD,          		BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//BB_U2TXD
{REG_PIN_U2RXD,                		BITS_AF(3)},
{REG_GROUP_PIN_U2RXD,          		BITS_DEF(0x75)|BIT_SLP_NONE|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//FINGER_VDD_EN
...
{REG_GROUP_PIN_IIS3DI,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//LED_RED_ATC
{REG_PIN_IIS3DO,                	BITS_AF(3)},
{REG_GROUP_PIN_IIS3DO,          	BITS_DEF(0x75)|BIT_SLP_NONE|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//FTID_RSTN
{REG_PIN_IIS3CLK,                	BITS_AF(3)},
{REG_GROUP_PIN_IIS3CLK,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//LCM_ID1 /  LCDID??????????
{REG_PIN_IIS3LRCK,                	BITS_AF(3)},
{REG_GROUP_PIN_IIS3LRCK,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//LCM_ID0  /  LCDID??????????
{REG_PIN_IIS1DI,                	BITS_AF(0)},
{REG_GROUP_PIN_IIS1DI,          	BITS_DEF(0x75)|BIT_SLP_ALL|BITS_STR(1)|BIT_WPD|BIT_SLP_WPD|BIT_SLP_IE},//SPA_GAINIO  /IIS function
{REG_PIN_IIS1DO,                	BITS_AF(0)},
{REG_GROUP_PIN_IIS1DO,          	BITS_DEF(0x75)|BIT_SLP_ALL|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//SPA_DIO /IIS function
{REG_PIN_IIS1CLK,                	BITS_AF(0)},
{REG_GROUP_PIN_IIS1CLK,          	BITS_DEF(0x75)|BIT_SLP_ALL|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//SPA_BCK /IIS function
{REG_PIN_IIS1LRCK,                	BITS_AF(0)},
{REG_GROUP_PIN_IIS1LRCK,          	BITS_DEF(0x75)|BIT_SLP_ALL|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//SPA_FS  /IIS function
{REG_PIN_SPI0_CSN,                	BITS_AF(0)},
{REG_GROUP_PIN_SPI0_CSN,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_WPU|BIT_SLP_Z},//FTID_SPI_CS
...
{REG_GROUP_PIN_EXTINT1,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//CTP_INT
{REG_PIN_EXTINT0,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_EXTINT0,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_ISO_VALUE|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CTP_RST
...
{REG_PIN_EXTINT15,                  BITS_PIN_AF(0)},
{REG_GROUP_PIN_EXTINT15,            BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//FPRINT_DOOM

//G11
{REG_PIN_SD2_CMD,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_CMD,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CAM_2M_AVDD_EN
{REG_PIN_SD2_D0,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_D0,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//LED_GREEN
{REG_PIN_SD2_D1,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_D1,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//LED_RED
{REG_PIN_SD2_CLK,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_CLK,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//NFCAM_AVDD_EN
{REG_PIN_SD2_D2,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_D2,            	BIT_PIN_SLP_ALL|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//SPA_INT
{REG_PIN_SD2_D3,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_D3,            	BIT_PIN_SLP_ALL|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//SPA_RST

//G13
{REG_PIN_SIMCLK2,                  	BITS_PIN_AF(1)},
{REG_GROUP_PIN_SIMCLK2,            	BIT_PIN_SLP_ALL|BIT_PIN_WPUS|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_Z},//I2C3_SCL
{REG_PIN_SIMDA2,                  	BITS_PIN_AF(1)},
{REG_GROUP_PIN_SIMDA2,            	BIT_PIN_SLP_ALL|BIT_PIN_WPUS|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_Z},//I2C3_SDA
{REG_PIN_SIMRST2,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SIMRST2,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//FS_DUALCAM
