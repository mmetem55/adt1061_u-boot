...
void dcdc_ldo_power_on(void)
{
	...
	regulator_enable("vdd28");
	regulator_set_voltage("vdd28", 2800000);
...
void pmic_lowpower_config(uint32_t ddie_id,uint32_t adie_id)
{
	...
	ANA_REG_SET(ANA_REG_GLB_DCDC_GPU_SLP_CTRL1, BITS_DCDC_GPU_CTRL_DS_SW(drop_val + CALIBRATION_DCDCGPU));
#endif
	...
	ANA_REG_SET(ANA_REG_GLB_TSX_CTRL0,
		...
		BITS_DCXO_26M_REF_OUT_EN(REFOUT0_ON  | REFOUT3_ON) |
		0
	);
