...
/*
 *Version SC9853-2_I-IA_V1.0.0_Pinmap_V1.0
 */
...
{REG_PIN_EXTINT10,                	BITS_AF(2)},
{REG_GROUP_PIN_EXTINT10,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//HAPTIC_PWM
{REG_PIN_EXTINT9,                 	BITS_AF(3)},
{REG_GROUP_PIN_EXTINT9,           	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_NUL|BIT_SLP_OE},//LCM_SOURCE_AVDDEN
...
{REG_GROUP_PIN_IIS3CLK,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_WPU|BIT_SLP_WPD|BIT_SLP_Z},//URSA_GPIO0
...
{REG_GROUP_PIN_SPI0_DO,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_WPD|BIT_SLP_Z},//FTID_SPI_DI
{REG_PIN_SPI0_DI,                	BITS_AF(0)},
{REG_GROUP_PIN_SPI0_DI,          	BITS_DEF(0x75)|BIT_SLP_AP|BITS_STR(1)|BIT_NUL|BIT_SLP_WPD|BIT_SLP_Z},//FTID_SPI_DO
...
{REG_GROUP_PIN_KEYIN1,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_OE},//VDDQ_EN
...
{REG_GROUP_PIN_SD2_D2,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_NUL|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//URSA_WLED_EN
{REG_PIN_SD2_D3,                  	BITS_PIN_AF(3)},
{REG_GROUP_PIN_SD2_D3,            	BIT_PIN_SLP_AP|BIT_PIN_NULL|BITS_PIN_DS(1)|BIT_PIN_WPU|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//URSA_NIRQ
