...
#define REG_PUB_APB_BUSMON_CNT_START                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0000)
#define REG_PUB_APB_BUSMON_CFG                            SCI_ADDR(REGS_PUB_APB_BASE, 0x0004)
#define REG_PUB_APB_DDR_EB                                SCI_ADDR(REGS_PUB_APB_BASE, 0x0008)
#define REG_PUB_APB_DDR_SOFT_RST                          SCI_ADDR(REGS_PUB_APB_BASE, 0x000C)
#define REG_PUB_APB_DDR_QOS_CFG1                          SCI_ADDR(REGS_PUB_APB_BASE, 0x0010)
#define REG_PUB_APB_DDR_QOS_CFG2                          SCI_ADDR(REGS_PUB_APB_BASE, 0x0014)
#define REG_PUB_APB_DDR_QOS_CFG3                          SCI_ADDR(REGS_PUB_APB_BASE, 0x0018)
#define REG_PUB_APB_DDR_MRR_STATUS                        SCI_ADDR(REGS_PUB_APB_BASE, 0x001C)
#define REG_PUB_APB_DDR_ID2QOS_SEL                        SCI_ADDR(REGS_PUB_APB_BASE, 0x003C)
#define REG_PUB_APB_DDR_ID2QOS_RCFG0                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0040)
#define REG_PUB_APB_DDR_ID2QOS_RCFG1                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0044)
#define REG_PUB_APB_DDR_ID2QOS_RCFG2                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0048)
#define REG_PUB_APB_DDR_ID2QOS_RCFG3                      SCI_ADDR(REGS_PUB_APB_BASE, 0x004c)
#define REG_PUB_APB_DDR_ID2QOS_RCFG4                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0050)
#define REG_PUB_APB_DDR_ID2QOS_RCFG5                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0054)
#define REG_PUB_APB_DDR_ID2QOS_RCFG6                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0058)
#define REG_PUB_APB_DDR_ID2QOS_RCFG7                      SCI_ADDR(REGS_PUB_APB_BASE, 0x005c)
#define REG_PUB_APB_DDR_ID2QOS_RCFG8                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0060)
#define REG_PUB_APB_DDR_ID2QOS_RCFG9                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0064)
#define REG_PUB_APB_DDR_ID2QOS_WCFG0                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0080)
#define REG_PUB_APB_DDR_ID2QOS_WCFG1                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0084)
#define REG_PUB_APB_DDR_ID2QOS_WCFG2                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0088)
#define REG_PUB_APB_DDR_ID2QOS_WCFG3                      SCI_ADDR(REGS_PUB_APB_BASE, 0x008c)
#define REG_PUB_APB_DDR_ID2QOS_WCFG4                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0090)
#define REG_PUB_APB_DDR_ID2QOS_WCFG5                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0094)
#define REG_PUB_APB_DDR_ID2QOS_WCFG6                      SCI_ADDR(REGS_PUB_APB_BASE, 0x0098)
#define REG_PUB_APB_DDR_ID2QOS_WCFG7                      SCI_ADDR(REGS_PUB_APB_BASE, 0x009c)
#define REG_PUB_APB_DDR_ID2QOS_WCFG8                      SCI_ADDR(REGS_PUB_APB_BASE, 0x00a0)
#define REG_PUB_APB_DDR_ID2QOS_WCFG9                      SCI_ADDR(REGS_PUB_APB_BASE, 0x00a4)
#define REG_PUB_APB_DFI_TIMEOUT_CFG                       SCI_ADDR(REGS_PUB_APB_BASE, 0x0100)
#define REG_PUB_APB_DFI_TIMEOUT_STATUS                    SCI_ADDR(REGS_PUB_APB_BASE, 0x0104)
#define REG_PUB_APB_DFI_TIMEOUT_EN_CNT                    SCI_ADDR(REGS_PUB_APB_BASE, 0x0108)
#define REG_PUB_APB_DFI_TIMEOUT_VALID_CNT                 SCI_ADDR(REGS_PUB_APB_BASE, 0x010c)
#define REG_PUB_APB_DMC_PORT_REMAP_EN                     SCI_ADDR(REGS_PUB_APB_BASE, 0x3000)
#define REG_PUB_APB_DMC_PORTS_MPU_EN                      SCI_ADDR(REGS_PUB_APB_BASE, 0x3004)
#define REG_PUB_APB_DMC_PORT0_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3008)
#define REG_PUB_APB_DMC_PORT1_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x300C)
#define REG_PUB_APB_DMC_PORT2_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3010)
#define REG_PUB_APB_DMC_PORT3_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3014)
#define REG_PUB_APB_DMC_PORT4_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3018)
#define REG_PUB_APB_DMC_PORT5_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x301C)
#define REG_PUB_APB_DMC_PORT6_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3020)
#define REG_PUB_APB_DMC_PORT7_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3024)
#define REG_PUB_APB_DMC_PORT8_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x3028)
#define REG_PUB_APB_DMC_PORT9_ADDR_REMAP                  SCI_ADDR(REGS_PUB_APB_BASE, 0x302C)
#define REG_PUB_APB_DMC_PORT0_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3030)
#define REG_PUB_APB_DMC_PORT1_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3034)
#define REG_PUB_APB_DMC_PORT2_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3038)
#define REG_PUB_APB_DMC_PORT3_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x303C)
#define REG_PUB_APB_DMC_PORT4_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3040)
#define REG_PUB_APB_DMC_PORT5_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3044)
#define REG_PUB_APB_DMC_PORT6_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3048)
#define REG_PUB_APB_DMC_PORT7_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3050)
#define REG_PUB_APB_DMC_PORT8_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3054)
#define REG_PUB_APB_DMC_PORT9_MPU_RANGE                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3058)
#define REG_PUB_APB_DMC_PORT0_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x305C)
#define REG_PUB_APB_DMC_PORT1_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3060)
#define REG_PUB_APB_DMC_PORT2_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3064)
#define REG_PUB_APB_DMC_PORT3_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3068)
#define REG_PUB_APB_DMC_PORT4_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x306C)
#define REG_PUB_APB_DMC_PORT5_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3070)
#define REG_PUB_APB_DMC_PORT6_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3074)
#define REG_PUB_APB_DMC_PORT7_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3078)
#define REG_PUB_APB_DMC_PORT8_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x307C)
#define REG_PUB_APB_DMC_PORT9_DUMP_ADDR                   SCI_ADDR(REGS_PUB_APB_BASE, 0x3080)
