...
#define REG_AON_APB_AON_CHIP_ID_H                      SCI_ADDR(REGS_AON_APB_BASE, 0x00F8)/*CHIP_ID_H*/
#define REG_AON_APB_AON_CHIP_ID                        SCI_ADDR(REGS_AON_APB_BASE, 0x00FC)/*CHIP_ID_L*/
...
/* bits definitions for register REG_AON_APB_RF_APB_EB0 */
...
/* bits definitions for register REG_AON_APB_RF_APB_RST0 */
...
/* bits definitions for register REG_AON_APB_RF_APB_RST1 */
...
/* bits definitions for register REG_AON_APB_RF_APB_RTC_EB */
...
/* bits definitions for register REG_AON_APB_RF_REC_26MHZ_BUF_CFG */
...
/* bits definitions for register REG_AON_APB_RF_SINDRV_CTRL */
...
/* bits definitions for register REG_AON_APB_RF_PWR_CTRL */
...
/* bits definitions for register REG_AON_APB_RF_TS_CFG */
...
/* bits definitions for register REG_AON_APB_RF_BOOT_MODE */
...
/* bits definitions for register REG_AON_APB_RF_BB_BG_CTRL */
...
/* bits definitions for register REG_AON_APB_RF_CP_ARM_JTAG_CTRL */
#define BITS_CP_ARM_JTAG_PIN_SEL(_X_)                     ( (_X_) & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for register REG_AON_APB_RF_PLL_SOFT_CNT_DONE */
...
/* bits definitions for register REG_AON_APB_RF_DCXO_LC_REG0 */
#define BIT_DCXO_LC_FLAG                                  ( BIT(8) )
#define BIT_DCXO_LC_FLAG_CLR                              ( BIT(1) )
#define BIT_DCXO_LC_CNT_CLR                               ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_DCXO_LC_REG1 */
#define BITS_DCXO_LC_CNT(_X_)                             (_X_)

/* bits definitions for register REG_AON_APB_RF_MPLL_CFG1 */
...
/* bits definitions for register REG_AON_APB_RF_MPLL_CFG2 */
...
/* bits definitions for register REG_AON_APB_RF_DPLL_CFG1 */
...
/* bits definitions for register REG_AON_APB_RF_DPLL_CFG2 */
...
/* bits definitions for register REG_AON_APB_RF_TWPLL_CFG1 */
...
/* bits definitions for register REG_AON_APB_RF_TWPLL_CFG2 */
...
/* bits definitions for register REG_AON_APB_RF_LTEPLL_CFG1 */
...
/* bits definitions for register REG_AON_APB_RF_LTEPLL_CFG2 */
...
/* bits definitions for register REG_AON_APB_RF_LVDSDISPLL_CFG1 */
...
/* bits definitions for register REG_AON_APB_RF_LVDSDISPLL_CFG2 */
...
/* bits definitions for register REG_AON_APB_RF_AON_REG_PROT */
...
/* bits definitions for register REG_AON_APB_RF_LDSP_BOOT_EN */
#define BIT_FRC_CLK_LDSP_EN                               ( BIT(1) )
#define BIT_LDSP_BOOT_EN                                  ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_LDSP_BOOT_VEC */
#define BITS_LDSP_BOOT_VECTOR(_X_)                        (_X_)

/* bits definitions for register REG_AON_APB_RF_LDSP_RST */
#define BIT_LDSP_SYS_SRST                                 ( BIT(1) )
#define BIT_LDSP_CORE_SRST_N                              ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_LDSP_MTX_CTRL1 */
#define BITS_LDSP_MTX_CTRL1(_X_)                          (_X_)

/* bits definitions for register REG_AON_APB_RF_LDSP_MTX_CTRL2 */
#define BITS_LDSP_MTX_CTRL2(_X_)                          (_X_)

/* bits definitions for register REG_AON_APB_RF_LDSP_MTX_CTRL3 */
#define BITS_LDSP_MTX_CTRL3(_X_)                          (_X_)

/* bits definitions for register REG_AON_APB_RF_AON_CGM_CFG */
...
/* bits definitions for register REG_AON_APB_RF_LACC_MTX_CTRL */
#define BITS_LACC_MTX_CTRL(_X_)                           (_X_)

/* bits definitions for register REG_AON_APB_RF_CORTEX_MTX_CTRL1 */
#define BITS_CORTEX_MTX_CTRL1(_X_)                        (_X_)

/* bits definitions for register REG_AON_APB_RF_CORTEX_MTX_CTRL2 */
#define BITS_CORTEX_MTX_CTRL2(_X_)                        (_X_)

/* bits definitions for register REG_AON_APB_RF_CORTEX_MTX_CTRL3 */
...
/* bits definitions for register REG_AON_APB_RF_CA5_TCLK_DLY_LEN */
...
/* bits definitions for register REG_AON_APB_RF_CCIR_RCVR_CFG */
...
/* bits definitions for register REG_AON_APB_RF_LVDSDIS_SEL */
#define BITS_LVDSDIS_LOG_SEL(_X_)                         ( (_X_) << 1 & (BIT(1)|BIT(2)) )
#define BIT_LVDSDIS_DBG_SEL                               ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_DJTAG_MUX_SEL */
...
/* bits definitions for register REG_AON_APB_RF_ARM7_SYS_SOFT_RST */
#define BIT_ARM7_SYS_SOFT_RST                             ( BIT(4) )
#define BIT_ARM7_CORE_SOFT_RST                            ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_CP1_CP0_ADDR_MSB */
#define BITS_CP1_CP0_ADDR_MSB(_X_)                        ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_AON_APB_RF_AON_DMA_INT_EN */
...
/* bits definitions for register REG_AON_APB_RF_CP0_ADDR_REMAP_CTRL0 */
...
#define BIT_AON_CA7_EMC_AUTO_GATE_EN                      ( BIT(0) )

/* bits definitions for register REG_AON_APB_ARM7_CFG_BUS */
#define BIT_ARM7_CFG_BUS_SLEEP                            ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_CP1_ADDR_REMAP_CTRL0 */
...
/* bits definitions for register REG_AON_APB_RF_CP1_ADDR_REMAP_CTRL1 */
...
/* bits definitions for register REG_AON_APB_RF_IO_DLY_CTRL */
...
/* bits definitions for register REG_AON_APB_RF_AP_WPROT_EN */
#define BITS_AP_AWADDR_WPROT_EN0(_X_)                     (_X_)

/* bits definitions for register REG_AON_APB_RF_CP0_WPROT_EN */
#define BITS_CP0_AWADDR_WPROT_EN0(_X_)                    (_X_)

/* bits definitions for register REG_AON_APB_RF_CP1_WPROT_EN */
...
/* bits definitions for register REG_AON_APB_RF_THM_RST_MONITOR */
#define BITS_THM_RST_MONITOR(_X_)                         (_X_)

/* bits definitions for register REG_AON_APB_RF_AP_RST_MONITOR */
#define BITS_AP_RST_MONITOR(_X_)                          (_X_)

/* bits definitions for register REG_AON_APB_RF_CA7_RST_MONITOR */
#define BITS_CA7_RST_MONITOR(_X_)                         (_X_)

/* bits definitions for register REG_AON_APB_RF_BOND_OPT0 */
#define BITS_BOND_OPTION0(_X_)                            (_X_)

/* bits definitions for register REG_AON_APB_RF_BOND_OPT1 */
#define BITS_BOND_OPTION1(_X_)                            (_X_)

/* bits definitions for register REG_AON_APB_RF_RES_REG0 */
#define BITS_RES_REG0(_X_)                                (_X_)

/* bits definitions for register REG_AON_APB_RF_RES_REG1 */
#define BITS_RES_REG1(_X_)                                (_X_)

/* bits definitions for register REG_AON_APB_RF_AON_QOS_CFG */
...
/* bits definitions for register REG_AON_APB_RF_BB_LDO_CAL_START */
#define BIT_BB_LDO_CAL_START                              ( BIT(0) )

/* bits definitions for register REG_AON_APB_RF_AON_MTX_PROT_CFG */
#define BITS_AON_HPROT_DMAW(_X_)                          ( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_AON_HPROT_DMAR(_X_)                          ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_AON_APB_RF_LVDS_CFG */
...
/* bits definitions for register REG_AON_APB_RF_AON_CHIP_ID */
