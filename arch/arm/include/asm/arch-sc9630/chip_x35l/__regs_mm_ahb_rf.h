...
#define REG_MM_AHB_RF_AHB_EB                              SCI_ADDR(REGS_MM_AHB_BASE, 0x0000)
#define REG_MM_AHB_RF_AHB_RST                             SCI_ADDR(REGS_MM_AHB_BASE, 0x0004)
#define REG_MM_AHB_RF_GEN_CKG_CFG                         SCI_ADDR(REGS_MM_AHB_BASE, 0x0008)
#define REG_MM_AHB_RF_MIPI_CSI2_CTRL                      SCI_ADDR(REGS_MM_AHB_BASE, 0x000C)
#define REG_MM_AHB_RF_MM_QOS_CFG                          SCI_ADDR(REGS_MM_AHB_BASE, 0x0010)
