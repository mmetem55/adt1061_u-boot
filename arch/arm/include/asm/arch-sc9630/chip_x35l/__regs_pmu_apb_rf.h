...
/* registers definitions for PMU_APB_RF */
...
#define REG_PMU_APB_PD_CP0_HU3GE_CFG                   SCI_ADDR(REGS_PMU_APB_BASE, 0x002C)
#define REG_PMU_APB_PD_CP0_GSM_0_CFG                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0030)
#define REG_PMU_APB_PD_CP0_GSM_1_CFG                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0034)
#define REG_PMU_APB_PD_CP0_TD_CFG                      SCI_ADDR(REGS_PMU_APB_BASE, 0x0038)
#define REG_PMU_APB_PD_CP0_CEVA_0_CFG                  SCI_ADDR(REGS_PMU_APB_BASE, 0x003C)
#define REG_PMU_APB_PD_CP0_CEVA_1_CFG                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0040)
#define REG_PMU_APB_PD_CP0_SYS_CFG                     SCI_ADDR(REGS_PMU_APB_BASE, 0x0044)
#define REG_PMU_APB_PD_CP1_CA5_CFG                     SCI_ADDR(REGS_PMU_APB_BASE, 0x0048)
#define REG_PMU_APB_PD_CP1_LTE_P1_CFG                  SCI_ADDR(REGS_PMU_APB_BASE, 0x004C)
#define REG_PMU_APB_PD_CP1_LTE_P2_CFG                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0050)
#define REG_PMU_APB_PD_CP1_CEVA_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0054)
#define REG_PMU_APB_PD_CP1_COMWRAP_CFG                 SCI_ADDR(REGS_PMU_APB_BASE, 0x0058)
#define REG_PMU_APB_PD_PUB_SYS_CFG                     SCI_ADDR(REGS_PMU_APB_BASE, 0x005C)
#define REG_PMU_APB_AP_WAKEUP_POR_CFG                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0060)
#define REG_PMU_APB_XTL_WAIT_CNT                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0070)
#define REG_PMU_APB_XTLBUF_WAIT_CNT                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0074)
#define REG_PMU_APB_PLL_WAIT_CNT1                      SCI_ADDR(REGS_PMU_APB_BASE, 0x0078)
#define REG_PMU_APB_PLL_WAIT_CNT2                      SCI_ADDR(REGS_PMU_APB_BASE, 0x007C)
#define REG_PMU_APB_XTL0_REL_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0080)
#define REG_PMU_APB_XTL1_REL_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0084)
#define REG_PMU_APB_XTLBUF0_REL_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x008C)
#define REG_PMU_APB_XTLBUF1_REL_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0090)
#define REG_PMU_APB_MPLL_REL_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0094)
#define REG_PMU_APB_DPLL_REL_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0098)
#define REG_PMU_APB_LTEPLL_REL_CFG                     SCI_ADDR(REGS_PMU_APB_BASE, 0x009C)
#define REG_PMU_APB_TWPLL_REL_CFG                      SCI_ADDR(REGS_PMU_APB_BASE, 0x00A0)
#define REG_PMU_APB_LVDSDIS_PLL_REL_CFG                SCI_ADDR(REGS_PMU_APB_BASE, 0x00A4)
#define REG_PMU_APB_CP_SOFT_RST                        SCI_ADDR(REGS_PMU_APB_BASE, 0x00B0)
#define REG_PMU_APB_CP_SLP_STATUS_DBG0                 SCI_ADDR(REGS_PMU_APB_BASE, 0x00B4)
#define REG_PMU_APB_PWR_STATUS0_DBG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x00BC)
#define REG_PMU_APB_PWR_STATUS1_DBG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x00C0)
#define REG_PMU_APB_PWR_STATUS2_DBG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x00C4)
#define REG_PMU_APB_SLEEP_CTRL                         SCI_ADDR(REGS_PMU_APB_BASE, 0x00CC)
#define REG_PMU_APB_DDR_SLEEP_CTRL                     SCI_ADDR(REGS_PMU_APB_BASE, 0x00D0)
#define REG_PMU_APB_SLEEP_STATUS                       SCI_ADDR(REGS_PMU_APB_BASE, 0x00D4)
#define REG_PMU_APB_CA7_TOP_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x00E4)
#define REG_PMU_APB_CA7_C0_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x00E8)
#define REG_PMU_APB_CA7_C1_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x00EC)
#define REG_PMU_APB_CA7_C2_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x00F0)
#define REG_PMU_APB_CA7_C3_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x00F4)
#define REG_PMU_APB_DDR_CHN_SLEEP_CTRL0                SCI_ADDR(REGS_PMU_APB_BASE, 0x00F8)
#define REG_PMU_APB_DDR_CHN_SLEEP_CTRL1                SCI_ADDR(REGS_PMU_APB_BASE, 0x00FC)
#define REG_PMU_APB_DDR_OP_MODE_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x012C)
#define REG_PMU_APB_DDR_PHY_RET_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0130)
#define REG_PMU_APB_26M_SEL_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0134)
#define REG_PMU_APB_BISR_DONE_STATUS                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0138)
#define REG_PMU_APB_BISR_BUSY_STATUS                   SCI_ADDR(REGS_PMU_APB_BASE, 0x013C)
#define REG_PMU_APB_BISR_BYP_CFG                       SCI_ADDR(REGS_PMU_APB_BASE, 0x0140)
#define REG_PMU_APB_BISR_EN_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0144)
#define REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG0             SCI_ADDR(REGS_PMU_APB_BASE, 0x0148)
#define REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG1             SCI_ADDR(REGS_PMU_APB_BASE, 0x014C)
#define REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG2             SCI_ADDR(REGS_PMU_APB_BASE, 0x0150)
#define REG_PMU_APB_CGM_AUTO_GATE_SEL_CFG3             SCI_ADDR(REGS_PMU_APB_BASE, 0x0154)
#define REG_PMU_APB_CGM_FORCE_EN_CFG0                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0158)
#define REG_PMU_APB_CGM_FORCE_EN_CFG1                  SCI_ADDR(REGS_PMU_APB_BASE, 0x015C)
#define REG_PMU_APB_CGM_FORCE_EN_CFG2                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0160)
#define REG_PMU_APB_CGM_FORCE_EN_CFG3                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0164)
#define REG_PMU_APB_SLEEP_XTLON_CTRL                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0168)
#define REG_PMU_APB_MEM_SLP_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x016C)
#define REG_PMU_APB_MEM_SD_CFG                         SCI_ADDR(REGS_PMU_APB_BASE, 0x0170)
#define REG_PMU_APB_CA7_CORE_PU_LOCK                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0174)
#define REG_PMU_APB_ARM7_HOLD_CGM_EN                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0178)
#define REG_PMU_APB_PWR_CNT_WAIT_CFG0                  SCI_ADDR(REGS_PMU_APB_BASE, 0x017C)
#define REG_PMU_APB_PWR_CNT_WAIT_CFG1                  SCI_ADDR(REGS_PMU_APB_BASE, 0x0180)
#define REG_PMU_APB_RC0_REL_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0184)
#define REG_PMU_APB_RC1_REL_CFG                        SCI_ADDR(REGS_PMU_APB_BASE, 0x0188)
#define REG_PMU_APB_RC_CNT_WAIT_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x018C)
#define REG_PMU_APB_MEM_AUTO_SLP_CFG                   SCI_ADDR(REGS_PMU_APB_BASE, 0x0190)
#define REG_PMU_APB_MEM_AUTO_SD_CFG                    SCI_ADDR(REGS_PMU_APB_BASE, 0x0194)
#define REG_PMU_APB_CP0_PD_SHUTDOWN_CFG                SCI_ADDR(REGS_PMU_APB_BASE, 0x0198)
#define REG_PMU_APB_CP1_PD_SHUTDOWN_CFG                SCI_ADDR(REGS_PMU_APB_BASE, 0x019C)
#define REG_PMU_APB_WAKEUP_LOCK_EN                     SCI_ADDR(REGS_PMU_APB_BASE, 0x01A0)
#if defined(CONFIG_SP9830I)
#define REG_PMU_APB_PD_CODEC_TOP_CFG                   SCI_ADDR(REGS_PMU_APB_BASE, 0X01A4)
#endif
#define REG_PMU_APB_PD_CA7_C0_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x3000)
#define REG_PMU_APB_PD_CA7_C1_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x3004)
#define REG_PMU_APB_PD_CA7_C2_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x3008)
#define REG_PMU_APB_PD_CA7_C3_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x300C)
#define REG_PMU_APB_PD_CA7_TOP_SHUTDOWN_MARK_STATUS    SCI_ADDR(REGS_PMU_APB_BASE, 0x3010)
#define REG_PMU_APB_PD_AP_SYS_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x3014)
#define REG_PMU_APB_PD_GPU_TOP_SHUTDOWN_MARK_STATUS    SCI_ADDR(REGS_PMU_APB_BASE, 0x3018)
#define REG_PMU_APB_PD_MM_TOP_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x301C)
#define REG_PMU_APB_PD_CP0_ARM9_0_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x3020)
#define REG_PMU_APB_PD_CP0_ARM9_1_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x3024)
#define REG_PMU_APB_PD_CP0_CEVA_0_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x3028)
#define REG_PMU_APB_PD_CP0_CEVA_1_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x302C)
#define REG_PMU_APB_PD_CP0_GSM_0_SHUTDOWN_MARK_STATUS  SCI_ADDR(REGS_PMU_APB_BASE, 0x3030)
#define REG_PMU_APB_PD_CP0_GSM_1_SHUTDOWN_MARK_STATUS  SCI_ADDR(REGS_PMU_APB_BASE, 0x3034)
#define REG_PMU_APB_PD_CP0_TD_SHUTDOWN_MARK_STATUS     SCI_ADDR(REGS_PMU_APB_BASE, 0x3038)
#define REG_PMU_APB_PD_CP0_HU3GE_SHUTDOWN_MARK_STATUS  SCI_ADDR(REGS_PMU_APB_BASE, 0x303C)
#define REG_PMU_APB_PD_CP1_CA5_SHUTDOWN_MARK_STATUS    SCI_ADDR(REGS_PMU_APB_BASE, 0x3040)
#define REG_PMU_APB_PD_CP1_CEVA_SHUTDOWN_MARK_STATUS   SCI_ADDR(REGS_PMU_APB_BASE, 0x3044)
#define REG_PMU_APB_PD_CP1_LTE_P1_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x3048)
#define REG_PMU_APB_PD_CP1_LTE_P2_SHUTDOWN_MARK_STATUS SCI_ADDR(REGS_PMU_APB_BASE, 0x304C)
#define REG_PMU_APB_PD_CP1_COMWRAP_SHUTDOWN_MARK_STATUS    SCI_ADDR(REGS_PMU_APB_BASE, 0x3050)
#define REG_PMU_APB_PD_PUB_SYS_SHUTDOWN_MARK_STATUS    SCI_ADDR(REGS_PMU_APB_BASE, 0x3054)



/* bits definitions for register REG_PMU_APB_RF_PD_CA7_TOP_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CA7_C0_CFG */
#define BIT_PD_CA7_C0_WFI_SHUTDOWN_EN                     ( BIT(29) )
...
/* bits definitions for register REG_PMU_APB_RF_PD_CA7_C1_CFG */
#define BIT_PD_CA7_C1_WFI_SHUTDOWN_EN                     ( BIT(29) )
...
/* bits definitions for register REG_PMU_APB_RF_PD_CA7_C2_CFG */
#define BIT_PD_CA7_C2_WFI_SHUTDOWN_EN                     ( BIT(29) )
...
/* bits definitions for register REG_PMU_APB_RF_PD_CA7_C3_CFG */
#define BIT_PD_CA7_C3_WFI_SHUTDOWN_EN                     ( BIT(29) )
...
/* bits definitions for register REG_PMU_APB_RF_PD_AP_SYS_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_MM_TOP_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_GPU_TOP_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_ARM9_0_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_ARM9_1_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_HU3GE_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_GSM_0_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_GSM_1_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_TD_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_CEVA_0_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_CP0_CEVA_1_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PD_PUB_SYS_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_AP_WAKEUP_POR_CFG */
#define BIT_AP_WAKEUP_POR_N                               ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_XTL_WAIT_CNT */
...
/* bits definitions for register REG_PMU_APB_RF_XTLBUF_WAIT_CNT */
...
/* bits definitions for register REG_PMU_APB_RF_PLL_WAIT_CNT1 */
...
/* bits definitions for register REG_PMU_APB_RF_PLL_WAIT_CNT2 */
...
/* bits definitions for register REG_PMU_APB_RF_DPLL_REL_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_LTEPLL_REL_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_TWPLL_REL_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_LVDSDIS_PLL_REL_CFG */
...
/* bits definitions for register REG_PMU_APB_RF_PWR_STATUS0_DBG */
...
/* bits definitions for register REG_PMU_APB_RF_PWR_STATUS1_DBG */
...
/* bits definitions for register REG_PMU_APB_RF_PWR_STATUS2_DBG */
...
/* bits definitions for register REG_PMU_APB_RF_SLEEP_CTRL */
...
/* bits definitions for register REG_PMU_APB_RF_CA7_TOP_CFG */
#define BIT_CA7_L2RSTDISABLE                              ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_CA7_C0_CFG */
#define BIT_CA7_VINITHI_C0                                ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_CA7_C1_CFG */
#define BIT_CA7_VINITHI_C1                                ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_CA7_C2_CFG */
#define BIT_CA7_VINITHI_C2                                ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_CA7_C3_CFG */
#define BIT_CA7_VINITHI_C3                                ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_DDR_CHN_SLEEP_CTRL0 */
...
/* bits definitions for register REG_PMU_APB_RF_DDR_CHN_SLEEP_CTRL1 */
...
/* bits definitions for register REG_PMU_APB_RF_DDR_PHY_RET_CFG */
#define BIT_DDR_UMCTL_SOFT_RST                            ( BIT(16) )
#define BIT_DDR_PHY_CKE_RET_EN                            ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_26M_SEL_CFG */
...
#define BIT_PD_CA7_TOP_BISR_DONE                          ( BIT(4) )
#define BIT_PD_CA7_C3_BISR_DONE                           ( BIT(3) )
#define BIT_PD_CA7_C2_BISR_DONE                           ( BIT(2) )
#define BIT_PD_CA7_C1_BISR_DONE                           ( BIT(1) )
#define BIT_PD_CA7_C0_BISR_DONE                           ( BIT(0) )
...
#define BIT_PD_CA7_TOP_BISR_BUSY                          ( BIT(4) )
#define BIT_PD_CA7_C3_BISR_BUSY                           ( BIT(3) )
#define BIT_PD_CA7_C2_BISR_BUSY                           ( BIT(2) )
#define BIT_PD_CA7_C1_BISR_BUSY                           ( BIT(1) )
#define BIT_PD_CA7_C0_BISR_BUSY                           ( BIT(0) )
...
#define BIT_PD_CA7_TOP_BISR_FORCE_BYP                     ( BIT(4) )
#define BIT_PD_CA7_C3_BISR_FORCE_BYP                      ( BIT(3) )
#define BIT_PD_CA7_C2_BISR_FORCE_BYP                      ( BIT(2) )
#define BIT_PD_CA7_C1_BISR_FORCE_BYP                      ( BIT(1) )
#define BIT_PD_CA7_C0_BISR_FORCE_BYP                      ( BIT(0) )
...
#define BIT_PD_CA7_TOP_BISR_FORCE_EN                      ( BIT(4) )
#define BIT_PD_CA7_C3_BISR_FORCE_EN                       ( BIT(3) )
#define BIT_PD_CA7_C2_BISR_FORCE_EN                       ( BIT(2) )
#define BIT_PD_CA7_C1_BISR_FORCE_EN                       ( BIT(1) )
#define BIT_PD_CA7_C0_BISR_FORCE_EN                       ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_CGM_AUTO_GATE_SEL_CFG0 */
#define BITS_CGM_AUTO_GATE_SEL_CFG0(_X_)                  (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_AUTO_GATE_SEL_CFG1 */
#define BITS_CGM_AUTO_GATE_SEL_CFG1(_X_)                  (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_AUTO_GATE_SEL_CFG2 */
#define BITS_CGM_AUTO_GATE_SEL_CFG2(_X_)                  (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_AUTO_GATE_SEL_CFG3 */
#define BITS_CGM_AUTO_GATE_SEL_CFG3(_X_)                  (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_FORCE_EN_CFG0 */
#define BITS_CGM_FORCE_EN_CFG0(_X_)                       (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_FORCE_EN_CFG1 */
#define BITS_CGM_FORCE_EN_CFG1(_X_)                       (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_FORCE_EN_CFG2 */
#define BITS_CGM_FORCE_EN_CFG2(_X_)                       (_X_)

/* bits definitions for register REG_PMU_APB_RF_CGM_FORCE_EN_CFG3 */
...
/* bits definitions for register REG_PMU_APB_RF_MEM_SLP_CFG */
#define BITS_MEM_SLP_CFG(_X_)                             (_X_)

/* bits definitions for register REG_PMU_APB_RF_MEM_SD_CFG */
#define BITS_MEM_SD_CFG(_X_)                              (_X_)

/* bits definitions for register REG_PMU_APB_RF_CA7_CORE_PU_LOCK */
#define BIT_CA7_C3_GIC_WAKEUP_EN                          ( BIT(11) )
#define BIT_CA7_C2_GIC_WAKEUP_EN                          ( BIT(10) )
#define BIT_CA7_C1_GIC_WAKEUP_EN                          ( BIT(9) )
#define BIT_CA7_C0_GIC_WAKEUP_EN                          ( BIT(8) )
#define BIT_PMU_CA7_C3_PU_LOCK                            ( BIT(3) )
#define BIT_PMU_CA7_C2_PU_LOCK                            ( BIT(2) )
#define BIT_PMU_CA7_C1_PU_LOCK                            ( BIT(1) )
#define BIT_PMU_CA7_C0_PU_LOCK                            ( BIT(0) )

/* bits definitions for register REG_PMU_APB_RF_ARM7_HOLD_CGM_EN */
...
#define BIT_PD_CA7_TOP_CMG_HOLD_EN                        ( BIT(4) )
#define BIT_PD_CA7_C3_CMG_HOLD_EN                         ( BIT(3) )
#define BIT_PD_CA7_C2_CMG_HOLD_EN                         ( BIT(2) )
#define BIT_PD_CA7_C1_CMG_HOLD_EN                         ( BIT(1) )
#define BIT_PD_CA7_C0_CMG_HOLD_EN                         ( BIT(0) )
...
/* bits definitions for register REG_PMU_APB_WAKEUP_LOCK_EN */
...
#define BIT_PD_CA7_TOP_WAKEUP_LOCK_EN                     ( BIT(4) )
#define BIT_PD_CA7_C3_WAKEUP_LOCK_EN                      ( BIT(3) )
#define BIT_PD_CA7_C2_WAKEUP_LOCK_EN                      ( BIT(2) )
#define BIT_PD_CA7_C1_WAKEUP_LOCK_EN                      ( BIT(1) )
#define BIT_PD_CA7_C0_WAKEUP_LOCK_EN                      ( BIT(0) )

#if defined(CONFIG_SP9830I)
/* bits definitions for register REG_PMU_APB_PD_CODEC_TOP_CFG */
#define BIT_PD_CODEC_TOP_FORCE_SHUTDOWN                   (BIT(25))
#define BIT_PD_CODEC_TOP_AUTO_SHUTDOWN_EN                 (BIT(24))
#define BITS_PD_CODEC_TOP_PWR_ON_DLY(_X_)                 ((_X_) & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)))
#define BITS_PD_CODEC_TOP_PWR_ON_SEQ_DLY(_X_)             ((_X_) & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)))
#define BITS_PD_CODEC_TOP_ISO_ON_DLY(_X_)                 ((_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)))
#endif

/* bits definitions for register REG_PMU_APB_PD_CA7_C0_SHUTDOWN_MARK_STATUS */
#define BITS_PD_CA7_C0_SHUTDOWN_MARK(_X_)                 ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_CA7_C1_SHUTDOWN_MARK_STATUS */
#define BITS_PD_CA7_C1_SHUTDOWN_MARK(_X_)                 ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_CA7_C2_SHUTDOWN_MARK_STATUS */
#define BITS_PD_CA7_C2_SHUTDOWN_MARK(_X_)                 ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_CA7_C3_SHUTDOWN_MARK_STATUS */
#define BITS_PD_CA7_C3_SHUTDOWN_MARK(_X_)                 ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_CA7_TOP_SHUTDOWN_MARK_STATUS */
#define BITS_PD_CA7_TOP_SHUTDOWN_MARK(_X_)                ( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
