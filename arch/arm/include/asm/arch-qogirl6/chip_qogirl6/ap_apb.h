...
/*
 * SVN URL      : http://shsvn06/svn/CHIP/Interface/SharkL6/Autoreg/SHARKL6_RTL_0.5_DV_00/AP_SYS/SharkL6 AP APB Control Register.xls;AP_APB_REG
 *     Revision : 208688
 *     Author   : {author}
 *     Date     : {date}
 */
...
#define CTL_AP_APB_BASE                 SCI_IOMAP(0x20000000)
#endif

/* registers definitions for CTL_AP_APB, 0x20000000 */
...
#define REG_AP_APB_APB_EB1                                  SCI_ADDR(CTL_AP_APB_BASE, 0x000C)

/* bits definitions for REG_AP_APB_APB_EB, [0x20000000] */
#define BIT_AP_APB_CE_PUB_EB                                ( BIT(31) )
#define BIT_AP_APB_CE_SEC_EB                                ( BIT(30) )
#define BIT_AP_APB_AXI_REGU_EB                              ( BIT(28) )
#define BIT_AP_APB_I2C6_EB                                  ( BIT(27) )
#define BIT_AP_APB_I2C5_EB                                  ( BIT(26) )
...
/* bits definitions for REG_AP_APB_APB_RST, [0x20000004] */
#define BIT_AP_APB_UFS_AES_SOFT_RST                         ( BIT(29) )
#define BIT_AP_APB_AXI_REGU_SOFT_RST                        ( BIT(28) )
#define BIT_AP_APB_I2C6_SOFT_RST                            ( BIT(27) )
#define BIT_AP_APB_I2C5_SOFT_RST                            ( BIT(26) )
#define BIT_AP_APB_CKG_SOFT_RST                             ( BIT(25) )
#define BIT_AP_APB_UFS_REG_SOFT_RST                         ( BIT(24) )
...
/* bits definitions for REG_AP_APB_APB_MISC_CTRL, [0x20000008] */
#define BIT_AP_APB_I2C6_SEC_EB                              ( BIT(16) )
#define BIT_AP_APB_I2C5_SEC_EB                              ( BIT(15) )
...
/* bits definitions for REG_AP_APB_APB_EB1, [0x2000000C] */
#define BIT_AP_APB_FORCE_CLKTOP_PCLK_EN                     ( BIT(3) )
#define BIT_AP_APB_CKG_EB                                   ( BIT(2) )
#define BIT_AP_APB_UFS_REG_EB                               ( BIT(1) )
