...
/*
 * SVN URL      : http://shsvn06/svn/CHIP/Interface/SharkL6/Autoreg/AON_SYS/SharkL6 AON APB Control Register.xls;AON_APB_REG
 *     Revision : 241518
 *     Author   : {author}
 *     Date     : {date}
 */
...
#define CTL_AON_APB_BASE                SCI_IOMAP(0x64000000)
#endif

/* registers definitions for CTL_AON_APB, 0x64000000 */
...
#define REG_AON_APB_WCN_SDIO_CTRL0                          SCI_ADDR(CTL_AON_APB_BASE, 0x034C)
#define REG_AON_APB_WCN_SDIO_CTRL1                          SCI_ADDR(CTL_AON_APB_BASE, 0x0350)
#define REG_AON_APB_WCN_SDIO_CTRL2                          SCI_ADDR(CTL_AON_APB_BASE, 0x0354)
#define REG_AON_APB_WCN_SDIO_CTRL3                          SCI_ADDR(CTL_AON_APB_BASE, 0x0358)
#define REG_AON_APB_WCN_SDIO_STAT0                          SCI_ADDR(CTL_AON_APB_BASE, 0x035C)
#define REG_AON_APB_WCN_SDIO_STAT1                          SCI_ADDR(CTL_AON_APB_BASE, 0x0360)
#define REG_AON_APB_WCN_SDIO_STAT2                          SCI_ADDR(CTL_AON_APB_BASE, 0x0364)
#define REG_AON_APB_WCN_SDIO_STAT3                          SCI_ADDR(CTL_AON_APB_BASE, 0x0368)
#define REG_AON_APB_AON_MTX_M7_LPC_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x036C)
#define REG_AON_APB_AON_MTX_S10_LPC_CTRL                    SCI_ADDR(CTL_AON_APB_BASE, 0x0370)
#define REG_AON_APB_USB_UART_JTAG_MUX                       SCI_ADDR(CTL_AON_APB_BASE, 0x0374)
...
#define REG_AON_APB_WDG_RST_FLAG_CLR                        SCI_ADDR(CTL_AON_APB_BASE, 0x3024)

/* bits definitions for REG_AON_APB_APB_EB0, [0x64000000] */
#define BIT_AON_APB_TOP2WCN_EB_AUTO_SEL                     ( BIT(21) )
#define BIT_AON_APB_TOP2WCN_EB                              ( BIT(20) )
#define BIT_AON_APB_BUS_TRANSMON_EN                         ( BIT(19) )
...
/* bits definitions for REG_AON_APB_APB_EB1, [0x64000004] */
...
#define BIT_AON_APB_ADI_2ND_EB                              ( BIT(15) )
...
/* bits definitions for REG_AON_APB_APB_EB2, [0x64000008] */
...
/* bits definitions for REG_AON_APB_APB_RST0, [0x6400000C] */
...
/* bits definitions for REG_AON_APB_APB_RST1, [0x64000010] */
...
#define BIT_AON_APB_ADI_2ND_SOFT_RST                        ( BIT(15) )
...
/* bits definitions for REG_AON_APB_APB_RST2, [0x64000014] */
...
/* bits definitions for REG_AON_APB_APB_RTC_EB0, [0x64000018] */
...
/* bits definitions for REG_AON_APB_PWR_CTRL, [0x64000024] */
#define BIT_AON_APB_EFUSE_PWON_RD_END_FLAG                  ( BIT(2) )

/* bits definitions for REG_AON_APB_TS_CFG, [0x64000028] */
...
/* bits definitions for REG_AON_APB_BOOT_MODE, [0x6400002C] */
#define BIT_AON_APB_ARM_BOOT_MD4                            ( BIT(9) )
...
/* bits definitions for REG_AON_APB_BB_BG_CTRL, [0x64000030] */
...
/* bits definitions for REG_AON_APB_USER_RSV_FLAG1, [0x64000088] */
#define BIT_AON_APB_USER_RSV_FLAG1_B1                       ( BIT(1) )
#define BIT_AON_APB_USER_RSV_FLAG1_B0                       ( BIT(0) )

/* bits definitions for REG_AON_APB_CM4_SYS_SOFT_RST, [0x6400008C] */
#define BIT_AON_APB_CM4_SYS_SOFT_RST                        ( BIT(4) )
#define BIT_AON_APB_CM4_CORE_SOFT_RST                       ( BIT(0) )

/* bits definitions for REG_AON_APB_AUTO_GATE_CTRL0, [0x640000D0] */
...
/* bits definitions for REG_AON_APB_AUTO_GATE_CTRL1, [0x640000D4] */
...
#define BIT_AON_APB_CGM_AON_APB_WCN_FORCE_EN                ( BIT(1) )
#define BIT_AON_APB_CGM_AON_APB_WCN_AUTO_GATE_SEL           ( BIT(0) )

/* bits definitions for REG_AON_APB_AP_AXI_CTRL, [0x640000D8] */
...
/* bits definitions for REG_AON_APB_AON_CHIP_ID0, [0x640000E0] */
#define BIT_AON_APB_AON_CHIP_ID0(x)                         ( (x) )

/* bits definitions for REG_AON_APB_AON_CHIP_ID1, [0x640000E4] */
#define BIT_AON_APB_AON_CHIP_ID1(x)                         ( (x) )

/* bits definitions for REG_AON_APB_AON_PLAT_ID0, [0x640000E8] */
#define BIT_AON_APB_AON_PLAT_ID0(x)                         ( (x) )

/* bits definitions for REG_AON_APB_AON_PLAT_ID1, [0x640000EC] */
#define BIT_AON_APB_AON_PLAT_ID1(x)                         ( (x) )

/* bits definitions for REG_AON_APB_AON_IMPL_ID, [0x640000F0] */
#define BIT_AON_APB_AON_IMPL_ID(x)                          ( (x) )

/* bits definitions for REG_AON_APB_AON_MFT_ID, [0x640000F4] */
#define BIT_AON_APB_AON_MFT_ID(x)                           ( (x) )

/* bits definitions for REG_AON_APB_AON_VER_ID, [0x640000F8] */
#define BIT_AON_APB_AON_VER_ID(x)                           ( (x) )

/* bits definitions for REG_AON_APB_AON_CHIP_ID, [0x640000FC] */
#define BIT_AON_APB_AON_CHIP_ID(x)                          ( (x) )

/* bits definitions for REG_AON_APB_CCIR_RCVR_CFG, [0x64000100] */
#define BIT_AON_APB_ANALOG_PLL_RSV(x)                       ( (x) << 16 & (0xFFFF0000) )
#define BIT_AON_APB_ANALOG_TESTMUX(x)                       ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_PLL_BG_CFG, [0x64000108] */
#define BIT_AON_APB_PLL_BG_RSV(x)                           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)) )

/* bits definitions for REG_AON_APB_LVDSDIS_SEL, [0x6400010C] */
#define BIT_AON_APB_LVDSDIS_LOG_SEL(x)                      ( (x) << 1  & (BIT(1)|BIT(2)) )
#define BIT_AON_APB_LVDSDIS_DBG_SEL                         ( BIT(0) )

/* bits definitions for REG_AON_APB_AUTO_GATE_CTRL2, [0x64000114] */
...
/* bits definitions for REG_AON_APB_AUTO_GATE_CTRL3, [0x64000118] */
...
/* bits definitions for REG_AON_APB_APCPU_CTRL0, [0x6400011C] */
...
/* bits definitions for REG_AON_APB_SP_CFG_BUS, [0x64000124] */
...
/* bits definitions for REG_AON_APB_APB_RST3, [0x64000130] */
#define BIT_AON_APB_DJTAG_WCN_SOFT_RST                      ( BIT(11) )
...
/* bits definitions for REG_AON_APB_RC100M_CFG, [0x64000134] */
...
/* bits definitions for REG_AON_APB_CGM_REG1, [0x64000138] */
...
/* bits definitions for REG_AON_APB_CGM_CLK_TOP_REG1, [0x6400013C] */
...
/* bits definitions for REG_AON_APB_AUDCP_DSP_CTRL0, [0x64000140] */
#define BIT_AON_APB_AUDCP_DSP_BOOT_VECTOR(x)                ( (x) )

/* bits definitions for REG_AON_APB_AUDCP_DSP_CTRL1, [0x64000144] */
...
/* bits definitions for REG_AON_APB_AUDCP_CTRL, [0x6400014C] */
...
/* bits definitions for REG_AON_APB_WTLCP_LDSP_CTRL0, [0x64000150] */
#define BIT_AON_APB_WTLCP_LDSP_BOOT_VECTOR(x)               ( (x) )

/* bits definitions for REG_AON_APB_WTLCP_LDSP_CTRL1, [0x64000154] */
...
/* bits definitions for REG_AON_APB_WTLCP_TDSP_CTRL0, [0x64000158] */
#define BIT_AON_APB_WTLCP_TDSP_BOOT_VECTOR(x)               ( (x) )

/* bits definitions for REG_AON_APB_WTLCP_TDSP_CTRL1, [0x6400015C] */
...
/* bits definitions for REG_AON_APB_WTLCP_CTRL, [0x64000164] */
...
/* bits definitions for REG_AON_APB_WTL_WCDMA_EB, [0x64000168] */
...
/* bits definitions for REG_AON_APB_PCP_AON_EB, [0x64000170] */
...
/* bits definitions for REG_AON_APB_PCP_SOFT_RST, [0x64000174] */
...
/* bits definitions for REG_AON_APB_PUBCP_CTRL, [0x64000178] */
...
/* bits definitions for REG_AON_APB_WTLCP_LPC_CTRL, [0x64000180] */

/* bits definitions for REG_AON_APB_PUBCP_LPC_CTRL, [0x64000184] */
#define BIT_AON_APB_PUBCP_FRC_STOP_ACK                      ( BIT(8) )
#define BIT_AON_APB_PUBCP_FRC_STOP_REQ                      ( BIT(0) )

/* bits definitions for REG_AON_APB_AON_SOC_USB_CTRL, [0x64000190] */
#define BIT_AON_APB_USB_BUSCLK_SEL_SOC                      ( BIT(2) )
#define BIT_AON_APB_USB_DIVN_MUX_SEL                        ( BIT(1) )
#define BIT_AON_APB_AON_IIS_SEL                             ( BIT(0) )

/* bits definitions for REG_AON_APB_SOFT_RST_AON_ADD1, [0x640001A0] */
...
/* bits definitions for REG_AON_APB_VDSP_INT_CTRL, [0x640001A4] */
...
/* bits definitions for REG_AON_APB_EB_AON_ADD1, [0x640001B0] */
#define BIT_AON_APB_BSM_TMR_EB                              ( BIT(1) )

/* bits definitions for REG_AON_APB_DBG_DJTAG_CTRL, [0x640001C0] */
#define BIT_AON_APB_DBGSYS_CSSYS_STM_NSGUAREN               ( BIT(16) )
#define BIT_AON_APB_DJTAG_SRC_MUX_SEL                       ( BIT(0) )

/* bits definitions for REG_AON_APB_MBIST_EFUSE_CTRL, [0x640001FC] */
#define BIT_AON_APB_FUSEBOX_SELECT_BUFFER_SW                ( BIT(3) )
#define BIT_AON_APB_EFUSE_MUX_SEL_SW_DEFAULT0               ( BIT(2) )
#define BIT_AON_APB_EFUSE_MUX_SEL_SW_DEFAULT1               ( BIT(1) )
#define BIT_AON_APB_EFUSE_MUX_SEL_SW                        ( BIT(0) )

/* bits definitions for REG_AON_APB_OTG_PHY_TUNE, [0x64000200] */
...
/* bits definitions for REG_AON_APB_OTG_PHY_TEST, [0x64000204] */
...
/* bits definitions for REG_AON_APB_OTG_PHY_CTRL, [0x64000208] */
...
/* bits definitions for REG_AON_APB_PUBCP_SIM1_TOP_CTRL, [0x64000230] */
...
/* bits definitions for REG_AON_APB_PUBCP_SIM2_TOP_CTRL, [0x64000234] */
...
/* bits definitions for REG_AON_APB_PUBCP_SIM3_TOP_CTRL, [0x64000238] */
...
/* bits definitions for REG_AON_APB_AP_SIM_TOP_CTRL, [0x6400023C] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL1, [0x64000250] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL2, [0x64000254] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL3, [0x64000258] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL4, [0x6400025C] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL5, [0x64000260] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL6, [0x64000264] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL7, [0x64000268] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL8, [0x6400026C] */
...
/* bits definitions for REG_AON_APB_TOP_PU_NUM_CTRL9, [0x64000270] */
#define BIT_AON_APB_PU_NUM_WTL2DDR_REGSLICE(x)              ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_AON_APB_PU_NUM_AON_MTX_S10(x)                   ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_AON_APB_PU_NUM_AON_MTX_M7(x)                    ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_AON_APB_PU_NUM_PUBCP2WTL_ASYNC_BRIDGE(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_AON_APB_APCPU_MONITOR_STATUS, [0x64000280] */
...
/* bits definitions for REG_AON_APB_APCPU_DEBUG_PWR_LP_CTRL, [0x64000284] */
...
/* bits definitions for REG_AON_APB_APCPU_GIC_COL_LP_CTRL, [0x64000288] */
...
/* bits definitions for REG_AON_APB_APCPU_CLUSTER_ATB_LPC_CTRL, [0x6400028C] */
...
/* bits definitions for REG_AON_APB_APCPU_CLUSTER_APB_LPC_CTRL, [0x64000290] */
...
/* bits definitions for REG_AON_APB_APCPU_CLUSTER_GIC_LPC_CTRL, [0x64000294] */
...
/* bits definitions for REG_AON_APB_APCPU_GIC600_GIC_LPC_CTRL, [0x64000298] */
...
/* bits definitions for REG_AON_APB_APCPU_DBG_BLK_LPC_CTRL, [0x6400029C] */
...
/* bits definitions for REG_AON_APB_APCPU_TOP_MTX_M0_LPC_CTRL, [0x64000300] */
...
/* bits definitions for REG_AON_APB_APCPU_PU_NUM_CTRL, [0x64000304] */
...
/* bits definitions for REG_AON_APB_APCPU_CLUSTER_SCU_LPC_CTRL, [0x64000320] */
...
/* bits definitions for REG_AON_APB_APCPU_DDR_AB_LPC_CTRL, [0x64000324] */
...
/* bits definitions for REG_AON_APB_APCPU_QOS_CTRL, [0x64000328] */
...
/* bits definitions for REG_AON_APB_MPLL0_CTRL, [0x6400032C] */
...
/* bits definitions for REG_AON_APB_MPLL1_CTRL, [0x64000330] */
...
/* bits definitions for REG_AON_APB_MPLL2_CTRL, [0x64000334] */
...
/* bits definitions for REG_AON_APB_DPLL_CTRL, [0x64000340] */
...
/* bits definitions for REG_AON_APB_PUB_CLK_GATING_CTRL, [0x64000344] */
#define BIT_AON_APB_PUB_APB_FW_EB                           ( BIT(17) )
#define BIT_AON_APB_PUB_REG_EB                              ( BIT(16) )
#define BIT_AON_APB_DMC_EB                                  ( BIT(15) )

/* bits definitions for REG_AON_APB_DDRPHY_VREP, [0x64000348] */
...
/* bits definitions for REG_AON_APB_WCN_SDIO_CTRL0, [0x6400034C] */
#define BIT_AON_APB_WCN_PMU_SDIO_CTRL0(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_CTRL1, [0x64000350] */
#define BIT_AON_APB_WCN_PMU_SDIO_CTRL1(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_CTRL2, [0x64000354] */
#define BIT_AON_APB_WCN_PMU_SDIO_CTRL2(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_CTRL3, [0x64000358] */
#define BIT_AON_APB_WCN_PMU_SDIO_CTRL3(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_STAT0, [0x6400035C] */
#define BIT_AON_APB_WCN_PMU_SDIO_STAT0(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_STAT1, [0x64000360] */
#define BIT_AON_APB_WCN_PMU_SDIO_STAT1(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_STAT2, [0x64000364] */
#define BIT_AON_APB_WCN_PMU_SDIO_STAT2(x)                   ( (x) )

/* bits definitions for REG_AON_APB_WCN_SDIO_STAT3, [0x64000368] */
#define BIT_AON_APB_WCN_PMU_SDIO_STAT3(x)                   ( (x) )

/* bits definitions for REG_AON_APB_AON_MTX_M7_LPC_CTRL, [0x6400036C] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S10_LPC_CTRL, [0x64000370] */
...
/* bits definitions for REG_AON_APB_USB_UART_JTAG_MUX, [0x64000374] */
#define BIT_AON_APB_UART_JTAG_SEL                           ( BIT(3) )
#define BIT_AON_APB_USB_BYPASS_SEL                          ( BIT(2) )
#define BIT_AON_APB_DAP_USB_JTAG_SEL                        ( BIT(1) )
#define BIT_AON_APB_USB_JTAG_HW_SEL_EN                      ( BIT(0) )

/* bits definitions for REG_AON_APB_PUBCP2WTL_ASYNC_BRIDGE_LPC_CTRL, [0x6400037C] */
...
/* bits definitions for REG_AON_APB_CM42AON_LPC_CTRL, [0x64000380] */
...
/* bits definitions for REG_AON_APB_AON_MTX_MAIN_LPC_CTRL, [0x64000384] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M0_LPC_CTRL, [0x64000388] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M1_LPC_CTRL, [0x6400038C] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M2_LPC_CTRL, [0x64000390] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M3_LPC_CTRL, [0x64000394] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M4_LPC_CTRL, [0x64000398] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M5_LPC_CTRL, [0x6400039C] */
...
/* bits definitions for REG_AON_APB_AON_MTX_M6_LPC_CTRL, [0x640003A0] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S0_LPC_CTRL, [0x640003A4] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S1_LPC_CTRL, [0x640003A8] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S2_LPC_CTRL, [0x640003AC] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S3_LPC_CTRL, [0x640003B0] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S4_LPC_CTRL, [0x640003B4] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S5_LPC_CTRL, [0x640003B8] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S6_LPC_CTRL, [0x640003BC] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S7_LPC_CTRL, [0x640003C0] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S8_LPC_CTRL, [0x640003C4] */
...
/* bits definitions for REG_AON_APB_AON_MTX_S9_LPC_CTRL, [0x640003C8] */
...
/* bits definitions for REG_AON_APB_AP2GPU_SLI_LPC_CTRL, [0x640003CC] */
...
/* bits definitions for REG_AON_APB_AP2MM_SLI_LPC_CTRL, [0x640003D0] */
...
/* bits definitions for REG_AON_APB_WTLCP2DDR_SLI_LPC_CTRL, [0x640003D4] */
#define BIT_AON_APB_WTL2DDR_SLICE_LP_NUM(x)                 ( (x) << 1  & (BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)) )
#define BIT_AON_APB_WTL2DDR_SLICE_LP_EB                     ( BIT(0) )

/* bits definitions for REG_AON_APB_APCPU2AP_SLI_LPC_CTRL, [0x640003D8] */
...
/* bits definitions for REG_AON_APB_AUDCP2DDR_SLI_LPC_CTRL, [0x640003DC] */
...
/* bits definitions for REG_AON_APB_APCPU2DDR_SLI_LPC_CTRL, [0x640003E0] */
...
/* bits definitions for REG_AON_APB_AON2DDR_BRG_LPC_CTRL, [0x640003E4] */
...
/* bits definitions for REG_AON_APB_PUBCP2WTLCP_SLI_LPC_CTRL, [0x640003E8] */
...
/* bits definitions for REG_AON_APB_DCAM2DDR_SLI_LPC_CTRL, [0x640003EC] */
...
/* bits definitions for REG_AON_APB_DPU2DDR_SLI_LPC_CTRL, [0x640003F0] */
...
/* bits definitions for REG_AON_APB_GPU2DDR_SLI_LPC_CTRL, [0x640003F4] */
...
/* bits definitions for REG_AON_APB_ISP2DDR_SLI_LPC_CTRL, [0x640003F8] */
...
/* bits definitions for REG_AON_APB_AP2DDR_SLI_LPC_CTRL, [0x640003FC] */
...
/* bits definitions for REG_AON_APB_AON_APB_FREQ_CTRL, [0x64000400] */
...
/* bits definitions for REG_AON_APB_C2G_ANALOG_BB_TOP_CLK26MHZ_AUD_EN, [0x64000404] */
...
/* bits definitions for REG_AON_APB_MIPI_CSI_POWER_CTRL, [0x64000408] */
...
/* bits definitions for REG_AON_APB_SINDRV_POWER_CTRL, [0x6400040C] */
...
/* bits definitions for REG_AON_APB_AP_EMMC_PHY_CTRL, [0x64000440] */
...
/* bits definitions for REG_AON_APB_AP_SDIO0_PHY_CTRL, [0x64000444] */
...
/* bits definitions for REG_AON_APB_AP_SDIO1_PHY_CTRL, [0x64000448] */
...
/* bits definitions for REG_AON_APB_AP_SDIO2_PHY_CTRL, [0x6400044C] */
...
/* bits definitions for REG_AON_APB_PUBCP_SDIO0_PHY_CTRL, [0x64000450] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL0, [0x64000500] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL1, [0x64000504] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL2, [0x64000508] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL3, [0x6400050C] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL4, [0x64000510] */
...
/* bits definitions for REG_AON_APB_APCPU_INT_ENABLE_CTRL5, [0x64000514] */
...
/* bits definitions for REG_AON_APB_WDG_RST_FLAG, [0x64000824] */
...
/* bits definitions for REG_AON_APB_BOND_OPT0, [0x6400083C] */
#define BIT_AON_APB_BOND_OPTION0(x)                         ( (x) )

/* bits definitions for REG_AON_APB_DEVICE_LIFE_CYCLE, [0x64000840] */
#define BIT_AON_APB_BOND_OPTION1(x)                         ( (x) )

/* bits definitions for REG_AON_APB_RES_REG0, [0x64000844] */
#define BIT_AON_APB_RES_REG0(x)                             ( (x) )

/* bits definitions for REG_AON_APB_RES_REG1, [0x64000848] */
#define BIT_AON_APB_RES_REG1(x)                             ( (x) )

/* bits definitions for REG_AON_APB_RES_REG2, [0x6400084C] */
#define BIT_AON_APB_RES_REG2(x)                             ( (x) )

/* bits definitions for REG_AON_APB_RES_REG3, [0x64000850] */
#define BIT_AON_APB_RES_REG3(x)                             ( (x) )

/* bits definitions for REG_AON_APB_RES_REG4, [0x64000854] */
#define BIT_AON_APB_RES_REG4(x)                             ( (x) )

/* bits definitions for REG_AON_APB_AON_MTX_PROT_CFG, [0x64000858] */
#define BIT_AON_APB_HPROT_DMAW(x)                           ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AON_APB_HPROT_DMAR(x)                           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AON_APB_PLL_LOCK_OUT_SEL, [0x64000864] */
...
/* bits definitions for REG_AON_APB_CPU2DDR_BRIDGE_DEBUG_SIGNAL_R, [0x64000870] */
#define BIT_AON_APB_CPU2DDR_BRIDGE_DEBUG_SIGNAL_R(x)        ( (x) )

/* bits definitions for REG_AON_APB_AON2DDR_BRIDGE_DEBUG_SIGNAL_W, [0x64000874] */
#define BIT_AON_APB_AON2DDR_BRIDGE_DEBUG_SIGNAL_R(x)        ( (x) )

/* bits definitions for REG_AON_APB_AON2DDR_BRIDGE_DEBUG_SIGNAL_LIST, [0x64000878] */
...
/* bits definitions for REG_AON_APB_AUD2DDR_BRIDGE_DEBUG_SIGNAL_R, [0x6400087C] */
#define BIT_AON_APB_AUD2DDR_BRIDGE_DEBUG_SIGNAL_R(x)        ( (x) )

/* bits definitions for REG_AON_APB_PUBCP2WTL_BRIDGE_DEBUG_SIGNAL_R, [0x64000884] */
#define BIT_AON_APB_PUBCP2WTL_BRIDGE_DEBUG_SIGNAL_R(x)      ( (x) )

/* bits definitions for REG_AON_APB_LEAKAGE_MAGIC_WORD, [0x64000900] */
#define BIT_AON_APB_LEAKAGE_MAGIC_WORD(x)                   ( (x) )

/* bits definitions for REG_AON_APB_LEAKAGE_SWITCH, [0x64000904] */
#define BIT_AON_APB_LEAKAGE_SWITCH                          ( BIT(0) )

/* bits definitions for REG_AON_APB_FUNC_TEST_BOOT_ADDR, [0x64000910] */
#define BIT_AON_APB_FUNC_TEST_BOOT_ADDR(x)                  ( (x) )

/* bits definitions for REG_AON_APB_CGM_RESCUE, [0x64000914] */
#define BIT_AON_APB_CGM_RESCUE(x)                           ( (x) )

/* bits definitions for REG_AON_APB_AON_SDIO, [0x6400092C] */
...
/* bits definitions for REG_AON_APB_SP_WAKEUP_MASK_EN0, [0x64000984] */
...
/* bits definitions for REG_AON_APB_SP_WAKEUP_MASK_EN1, [0x64000988] */
...
/* bits definitions for REG_AON_APB_SP_WAKEUP_MASK_EN2, [0x6400098C] */
#define BIT_AON_APB_SP_INT_REQ_WCN_BTWF_WDG_WAKEUP_EN       ( BIT(14) )
#define BIT_AON_APB_SP_INT_REQ_WCN_GNSS_WDG_WAKEUP_EN       ( BIT(13) )
...
/* bits definitions for REG_AON_APB_DBG_BUS_DATA_WTLCP, [0x64000990] */
#define BIT_AON_APB_DBG_BUS_DATA_WTLCP(x)                   ( (x) )

/* bits definitions for REG_AON_APB_DBG_BUS_DATA_PUBCP, [0x64000994] */
#define BIT_AON_APB_DBG_BUS_DATA_PUBCP(x)                   ( (x) )

/* bits definitions for REG_AON_APB_DBG_BUS_DATA_AUDCP, [0x64000998] */
#define BIT_AON_APB_DBG_BUS_DATA_AUDCP(x)                   ( (x) )

/* bits definitions for REG_AON_APB_SCC_DBG_BUS, [0x64000A00] */
#define BIT_AON_APB_SCC_DBG_BUS(x)                          ( (x) )

/* bits definitions for REG_AON_APB_AON_FUNC_CTRL_0, [0x64000A04] */
#define BIT_AON_APB_AON_FUNC_CTRL_0(x)                      ( (x) )

/* bits definitions for REG_AON_APB_AON_FUNC_CTRL_1, [0x64000A08] */
#define BIT_AON_APB_AON_FUNC_CTRL_1(x)                      ( (x) )

/* bits definitions for REG_AON_APB_WDG_RST_FLAG_CLR, [0x64003024] */
#define BIT_AON_APB_AP_WDG_RST_FLAG_CLR                     ( BIT(6) )
#define BIT_AON_APB_PCP_WDG_RST_FLAG_CLR                    ( BIT(5) )
#define BIT_AON_APB_WTLCP_LTE_WDG_RST_FLAG_CLR              ( BIT(4) )
#define BIT_AON_APB_WTLCP_TG_WDG_RST_FLAG_CLR               ( BIT(3) )
#define BIT_AON_APB_AUDCP_WDG_RST_FLAG_CLR                  ( BIT(2) )
#define BIT_AON_APB_APCPU_WDG_RST_FLAG_CLR                  ( BIT(1) )
#define BIT_AON_APB_SEC_WDG_RST_FLAG_CLR                    ( BIT(0) )
