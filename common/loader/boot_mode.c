...
/* Reconstruct the do_fastboot(void) entry the deleted common/loader/fastboot.c
 * used to provide; drive the sprd fastboot gadget that is always built (obj-y).
 */
int do_fastboot(void)
{
	return usb_fastboot_init();
}
