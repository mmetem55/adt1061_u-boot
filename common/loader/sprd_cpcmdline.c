...
#endif
/* check the data only thought gpio */
#ifdef CONFIG_DATA_MODE
	...
	sprintf(buf,"%s",(value_simmode?"singlesim":"dualsim"));
	cmdline_add_cp_cmdline(SIM_MODE, buf);
#endif
#ifdef CONFIG_SC9833
	{
