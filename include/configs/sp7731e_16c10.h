...
#define CONFIG_ARCH_SCX35L2
#define CONFIG_ARCH_SCX35L
#define CONFIG_SPRD_UID

/* sprd native board id */
#define CONFIG_BOARDID_NATIVE
...
#define LTE_FIXNV_SIZE 0x00088000 // 544K the max size is 768K
#define LTE_RUNNV_SIZE 0x000a8000 // 672k the max size is 768K
...
#define LTE_GDSP_SIZE  0x00300000
...
//#define CONFIG_MMC_1BIT_BUS_MODE
...
#define PHYS_SDRAM_1_SIZE	0x7fe00000
...
#define CONFIG_LCD_ST7701_COE_MIPI_WVGA
#define CONFIG_LCD_ST7701_BOE_MIPI_WVGA
#define CONFIG_LCD_ILI9881C_3LANE_MIPI_HD
#define CONFIG_LCM_GPIO_RSTN	32
#define CONFIG_LCM_GPIO_ID	47
...
#define CALIBRATION_FLAG_CP1        (0x8AE40000)
